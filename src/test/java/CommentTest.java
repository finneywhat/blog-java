...
public class CommentTest {
  ...
  public void comment_instantiatesCorrectly() {
    Comment testComment = new Comment("great post", 1, 1);
  ...
  public void equals_comparesCommentsBasedOnContentAndPostId() {
    Comment testComment1 = new Comment("great post", 1, 1);
    Comment testComment2 = new Comment("great post", 1, 1);
  ...
  public void all_returnsAllCommentsInDB() {
    Comment testComment1 = new Comment("great post", 1, 1);
    testComment1.save();
    Comment testComment2 = new Comment("really great post", 2, 1);
    testComment2.save();
