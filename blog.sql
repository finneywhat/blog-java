...
2	Really Really Really Great Post!!	4	1
5	Your Right Harry. Dogs are Cool!!!	4	2
\.
...
SELECT pg_catalog.setval('posts_tags_id_seq', 16, true);
...
1	user@gmail.com	Harry Reynold
2	brandt.janek@gmail.com	Janek
\.
